...
export function NewNoteCard({  onNoteCreated  }: NewNoteCardProps) {
    ...
    return(
        ...
        <Dialog.Root>
        <Dialog.Trigger className=' flex flex-col rounded-nd bg-slate-700 p-5 text-left gap-3 hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>   
            <span className='text-sm font-medium text-slate-200'>
              Adicionar nota
            </span>
            <p className='text-sm leading-6 text-slate-400'>
              Grave a nota em áudio que será convertida para texto automaticamente.
            </p>
